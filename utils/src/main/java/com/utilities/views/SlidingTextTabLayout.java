...
public class SlidingTextTabLayout extends HorizontalScrollView {
    ...
    public SlidingTextTabLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link SlidingTextTabLayout} you are
